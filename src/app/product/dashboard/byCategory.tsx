...
const ByCategory = () => {
  ...
  return (
    <div className="bg-white p-2 md:p-4 lg:p-4 mx-3 mt-3 md:mx-5 md:mt-5 lg:mx-5 lg:mt-5 rounded-xl">
      <h2 className="px-2 md:px-14 lg:px-14 mb-2 md:mb-4 lg:mb-4 font-bold text-xl">
        Popular Products by Category
      </h2>
      <div className="flex w-full items-center space-x-1">
        <button className="by-category-swiper-prev arrow">
          <svg
        ...
        <Swiper
          ...
          navigation={{
            nextEl: ".by-category-swiper-next",
            prevEl: ".by-category-swiper-prev",
          }}
        >
          {products.map((product: any, index: number) => (
            <SwiperSlide key={index} className="p-1 rounded-lg bg-green-200">
              <Link
        ...
        <button className="by-category-swiper-next arrow">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="52"
            height="52"
