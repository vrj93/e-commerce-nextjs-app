...
const Navbar = () => {
    ...
    const [authState, setNormalAuthState] = useState(false); //storing Redux state to normal State for mitigating client/server state mismatch on reload.
        ...
        <>
            <nav className='bg-gray-900 flex w-full items-center justify-center space-x-10 py-2'>
                ...
                <a href='#' onClick={() => router.push('/')}>
                    <Image className="mx-auto h-10 w-auto" src='/amzlogo3.svg' alt='AMZ' width={0} height={0} />
                </a>
                {/*location*/}
                            ...
                            <div
                                className="invisible absolute right-0 z-50 flex w-56 flex-col text-center bg-gray-100 py-1 pt-2 px-4 text-gray-800 shadow-xl group-hover:visible">
                                {
                                    ...
                                    <div className='mb-2 border-b-2 p-0'>
                                        <a href='#'
                                           className="mt-2 block border-b border-gray-100 pt-1 font-semibold text-gray-500 hover:text-black md:mx-2">
                                            <button type='button'
                                ...
                                {
                                    authState &&
                                    <a className="block border-b border-gray-100 py-2 text-sm text-gray-500 hover:text-black md:mx-2"
                ...
                <div className='flex p-0 items-center justify-between space-x-5' style={{'marginLeft': '15px'}}>
                    <a href='#' className="text-base font-medium text-white lg:mx-4"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <defs>
                                    <linearGradient id="a" x1="57.791" x2="68.393" y1="100.585" y2="111.187"
                                        ...
                                        <stop offset="0" stopColor="#f15550"
                                              className="stopColorf15550 svgShape"></stop>
                                        <stop offset=".302" stopColor="#e0404b"
                                              className="stopColore0404b svgShape"></stop>
                                        <stop offset=".734" stopColor="#cd2845"
                                              className="stopColorcd2845 svgShape"></stop>
                                        <stop offset="1" stopColor="#c61f43"
                                              className="stopColorc61f43 svgShape"></stop>
                                    </linearGradient>
                                    ...
                                    <linearGradient id="d" x1="54.317" x2="103.693" y1="106.735" y2="78.227"
                                                    gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stopColor="#fbac46"
                                              className="stopColorfbac46 svgShape"></stop>
                                        <stop offset="1" stopColor="#d38b23"
                                              className="stopColord38b23 svgShape"></stop>
                                    </linearGradient>
                                    <linearGradient id="e" x1="53.858" x2="95.856" y1="9.632" y2="82.375"
                                                    gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stopColor="#fcea73"
                                              className="stopColorfcea73 svgShape"></stop>
                                        <stop offset=".249" stopColor="#fce670"
                                              className="stopColorfce670 svgShape"></stop>
                                        <stop offset=".508" stopColor="#fcd967"
                                              className="stopColorfcd967 svgShape"></stop>
                                        <stop offset=".769" stopColor="#fbc558"
                                              className="stopColorfbc558 svgShape"></stop>
                                        <stop offset="1" stopColor="#fbac46"
                                              className="stopColorfbac46 svgShape"></stop>
                                    </linearGradient>
                                    <linearGradient id="b" x1="61.325" x2="64.86" y1="104.119" y2="107.654"
                                        ...
                                        <stop offset="1" stopColor="#d7d7d7"
                                              className="stopColord7d7d7 svgShape"></stop>
                                    </linearGradient>
                                    ...
                                    <linearGradient id="g" x1="20.877" x2="20.877" y1="14.565" y2="29.774"
                                                    gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stopColor="#fd908d"
                                              className="stopColorfd908d svgShape"></stop>
                                        <stop offset="1" stopColor="#ec4547"
                                              className="stopColorec4547 svgShape"></stop>
                                    </linearGradient>
                                </defs>
